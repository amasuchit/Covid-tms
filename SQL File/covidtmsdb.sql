...
(2, 'Admin', 'admin', 1234567890, 'admin@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-03-24 18:30:00');

INSERT INTO `tbladmin` (`ID`, `AdminName`, `AdminuserName`, `MobileNumber`, `Email`, `Password`, `AdminRegdate`) VALUES
(3, 'Suchit Amatya', 'amasuchit', 9865423633, 'amatyasuchit@gmail.com', MD5('suchit'), '2022-03-25 02:30:00');

INSERT INTO `tbladmin` (`ID`, `AdminName`, `AdminuserName`, `MobileNumber`, `Email`, `Password`, `AdminRegdate`) VALUES
(4, 'Sabin Adhikari', 'sabin', 9821864795, 'sabin@gmail.com', MD5('sabin'), '2022-03-25 02:30:00');

INSERT INTO `tbladmin` (`ID`, `AdminName`, `AdminuserName`, `MobileNumber`, `Email`, `Password`, `AdminRegdate`) VALUES
(5, 'Suraj Karki', 'suraj', 9845364544, 'suraj@gmail.com', MD5('suraj'), '2022-03-25 02:30:00');

INSERT INTO `tbladmin` (`ID`, `AdminName`, `AdminuserName`, `MobileNumber`, `Email`, `Password`, `AdminRegdate`) VALUES
(6, 'Bhuban Magar', 'bhuban', 9878456123, 'bhuban@gmail.com', MD5('bhuban'), '2022-03-25 02:30:00');
