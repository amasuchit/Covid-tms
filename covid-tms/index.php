...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link js-scroll-trigger" href="search-report.php">Search your Reports</a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="lead">Coronavirus disease (COVID-19) is an infectious disease caused by a newly discovered
                        ...
                        respiratory illness & recover without requiring special treatment. Older people and those with
                        underlying medical problem like cardiovascular disease.</p>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; ASMT 2022</p>
        </div>
        <!-- /.container -->
    </footer>
